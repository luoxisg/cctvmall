...
| CCTV Cable Route and Power Point Tap-in Location | Required before submission |
| Site Survey Report / Finding signed by MA / HDB | Required before submission |

## Site-by-Site Readiness Table

| Site | Submission Record | Readiness | Key Action | Notes |
|---|---|---|---|---|
| Rivervale Plaza | TBC | TBC | TBC | Site-level submission path not consolidated here yet |
...
## Workstream Scope (Phase 1)

| Workstream | Sites |
|---|---|
| Univers Cloud BMS | Loyang Point, Rivervale Plaza |
| Xjera CCTV / VA / Footfall | Loyang Point, Canberra Plaza |

## Submission Blockers

| Blocker | Site | Impact | Status |
|---|---|---|---|
| Canberra Plaza survey report and MA/HDB sign-off (CR-06) | Canberra Plaza | Submission readiness cannot be completed without survey | Open |
| Cable route and power tap-in scope still needs confirmation | Loyang Point / TBC | Affects submission quality and scope clarity | Open |

## Submission Support Links

- Action follow-up: [02_Action Tracker](./02_Action Tracker.md)
- Site readiness: [04_Site & Installation Tracker](./04_Site & Installation Tracker.md)
- Risks and decisions: [05_Risk Commercial Decision Log](./05_Risk Commercial Decision Log.md)
